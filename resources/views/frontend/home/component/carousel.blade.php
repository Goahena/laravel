<div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="{{ URL('frontend_assets/images1/banner1.jpg') }}" class="d-block w-100" alt="..."/>
		...
		<div class="carousel-item">
			<img src="{{ URL('frontend_assets/images1/banner2.jpg') }}" class="d-block w-100" alt="..."/>
			<div class="carousel-caption d-none d-md-block">
				<h5>PVB Shop</h5>
		...
		{{-- <div class="carousel-item">
			<img src="{{ URL('frontend_assets/images1/banner0.jpg') }}" class="d-block w-100" alt="..."/>
